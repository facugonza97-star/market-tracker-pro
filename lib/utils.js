export function heatColor(val) {
  ...
  if (v < 0)    return { bg: "#5a2d2d", color: "#ffffff" };
  if (v === 0)  return { bg: "#1a1a2e", color: "#ffffff" };
  if (v < 0.5)  return { bg: "#2d5a3d", color: "#ffffff" };
  if (v < 2)    return { bg: "#3CB371", color: "#ffffff" };
  if (v < 5)    return { bg: "#2E8B57", color: "#ffffff" };
  if (v < 10)   return { bg: "#228B22", color: "#ffffff" };
  return { bg: "#006400", color: "#ffffff" };
}
